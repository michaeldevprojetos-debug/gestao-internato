...
handle_limpar_def = """export default function HospitaisPage() {
...
if "handleLimparPreceptor = async" not in code:
    code = code.replace("export default function HospitaisPage() {", handle_limpar_def)
